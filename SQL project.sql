...
select sum(total) as invoice_total,billing_city as city_name 
from invoice
group by city_name
...
the best customer. write a a query that returns the person who has spent the most money.
...
Q6: write query to return the email,first name, last name,& genre of all rock music listners.
...
________ Thank you_____________--